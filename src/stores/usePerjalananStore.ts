...
export const usePerjalananStore = create<PerjalananState>((set) => ({
  ...
  tambahPerjalanan: async (newPerjalanan,id) => {
    try {
      ...
      console.error("Gagal menambahkan atau memperbarui perjalanan:" );
    }  
  },
  ...
  hapusPerjalanan: async (id) => {
    try {
      ...
      console.error("Gagal menghapus perjalanan:", error);
    }
  },
  ...
  editPerjalanan: async (id, updatedData) => {
    try {
      ...
      console.error("Gagal mengupdate perjalanan:", error);
    }
  },
}));